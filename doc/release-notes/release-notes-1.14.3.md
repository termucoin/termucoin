...
Block download timeouts are expressed as a multiple of block interval, and as such Termubit block download times were relatively aggressive, leading to a high number of timeouts. Increased the timeouts to be more flexible to real world conditions.
