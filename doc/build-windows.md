...
Below are some notes on how to build Termubit Core for Windows.
...
```
Ensure that this toolchain can build for `posix` (else you may have compilation errors for Termubit's dependencies):
```bash
