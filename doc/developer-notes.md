...
- ThreadSocketHandler : Sends/Receives data from peers on port 8599.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 8598 for connections and services them.

- TermubitMiner : Generates termubits (if wallet is enabled).
...
- When looking at other's pull requests, it may make sense to add the following section to your `.git/config`
  file:
        ...
        [remote "upstream-pull"]
                ...
                url = git@github.com:termubit/termubit.git
