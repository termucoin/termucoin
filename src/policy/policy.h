...
/** Recommended transaction fee by Termubit Core developers
  *
  * All fee defaults used throughout the client derive their
  * value from this base default.
  */
static const CAmount RECOMMENDED_MIN_TX_FEE = COIN / 100000;
 ...
 *
 *  Termubit:    Increment mempool limits and accept RBF in steps of 0.0001 TERM
...
/**
 * Termubit: Default dust limit that is evaluated when considering whether a
...
/**
 * Termubit: Default hard dust limit that is evaluated when considering whether
