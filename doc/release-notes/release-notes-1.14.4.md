Termubit Core version 1.14.4 is now available from:

  <https://github.com/termubit/termubit/releases/tag/v1.14.4/>
...
operators to agree on fees regardless of defaults coded into the Termubit Core
...
* The default setting shipped with termubit core for relay fee has been reduced
