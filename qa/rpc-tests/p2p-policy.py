...
class P2PPolicyTests(BitcoinTestFramework):
    ...
    def setup_network(self):
        ...
        # a Termucoin Core node that behaves similar to mainnet policies
    ...
    def run_test(self):
        ...
        # create a bunch of UTXO with seed money from the Termucoin Core wallet
        for i in range(20):
        ...
        # test legacy output of 1 TERM output and 1 TERM fee
    ...
    # spend seed money with a key not in the Termucoin Core wallet.
    def spend_utxo(self, output, expected_size, retries=0):
        # construct the transaction using Termucoin Core raw tx APIs
        ...
        # and send the tx from there rather than from Termucoin Core, to test
