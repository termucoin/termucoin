...
// Copyright (c) 2021-2023 The Termubit Core developers
    ...
    platformStyle(_platformStyle)
{
    ...
    // Termubit: load fallback font in case Comic Sans is not available on the system
    ...
    // Termubit: load this bundled font for Settings -> Options in case it's not available on the system
    ...
    // Termubit: Specify Comic Sans as new font.
    QFont newFont("Comic Sans MS", 10);

    // Termubit: Set new application font
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Termubit address"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Termubit addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Termubit addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Termubit command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Termubit network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr("Termubit"); // default title
