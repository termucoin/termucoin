Termubit Core version 1.14.6 is now available from:
  ...
  <https://github.com/termubit/termubit/releases/tag/v1.14.6/>
...
```
termubit-cli addnode <address> remove
```
...
```
termubit-cli liststucktransactions
```
...
```
termubit-cli setmaxconnections <desired_amount>
```
...
```
termubit-cli rescan <start_block>
```
