...
Termubit Core is a direct fork of Bitcoin Core and therefore benefits from as
...
[bitcoin/bitcoin](https://github.com/bitcoin/bitcoin) and future Termubit Core
releases will automatically benefit from these.

When refactoring Termubit-specific code, please keep refactoring requests short,
...
The following applies to code changes to Termubit Core, and is not to be
confused with overall Termubit Network Protocol consensus changes. All consensus
...
Whether a pull request is merged into Termubit Core rests with the repository
maintainers.

Maintainers will take into consideration if a patch is in line with the general
principles of Termubit; meets the minimum standards for inclusion; and will
...
that have demonstrated a deeper commitment and understanding towards Termubit
(over time) or have clear domain expertise may naturally have more weight, as
one would expect in all walks of life.

Where a patch set proposes to change the Termubit consensus, it must have been
